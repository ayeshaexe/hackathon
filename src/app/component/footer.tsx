    ...
    return (
        <footer className="bg-white absolute">
            <section className="bg-[#f9f9f9] py-10 ">
                <div className="max-w-screen-xl mx-auto flex justify-between items-center">
                    <div className="flex flex-col">
                        <h1 className="text-[#252b42] text-2xl font-bold leading-loose tracking-tight ml-[90px]">Bandage</h1>
                    </div>
            ...
            <section className="bg-white py-12">
                <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-14">
                    <div>
                        <h2 className="text-[#252b42] text-base font-bold ml-[90px]">Company Info</h2>
                        <nav className="flex flex-col gap-2.5 mt-3 ml-[90px]">
                    ...
                    <div className="mr-[90px]">
                        ...
                        <div className="mt-3">
                            <div className="relative mb-4">
                                <input
                                    type="email"
                                    className="w-[200px] h-12 px-4 border border-[#e6e6e6] rounded-lg bg-[#f8f8f8] text-[#727272] text-sm font-normal"
                                    placeholder="Your Email"
                                />
                                <button className="absolute left-[110px] top-0 h-12 px-4  bg-[#23a6f0] text-white text-sm font-normal rounded-r-lg">
                                    Subscribe
                                </button>
                            </div>
            ...
            <section className="bg-[#f9f9f9] py-4 ml-[90px]">
                <div className="max-w-screen-xl mx-auto flex justify-between items-center">
